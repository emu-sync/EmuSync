...
function SyncStatusForm({ gameId, gameName }) {
    ...
    const { query, updateMutation } = (0, use_edit_query_1.default)({
        ...
        relatedQueryKeys: [gameSyncStatusKey, cache_keys_1.cacheKeys.gameList, gameLocalSyncLogsKey],
    ...
    return (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(SectionTitle_1.default, { title: "Sync status", icon: (0, jsx_runtime_1.jsx)(Sync_1.default, {}) }), (0, jsx_runtime_1.jsx)(LoadingHarness_1.default, { query: query, loadingState: (0, jsx_runtime_1.jsx)(LoadingState, {}), children: query.data ?
                    (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(DisplayGameSyncStatus_1.default, { gameSyncStatus: query.data }), (0, jsx_runtime_1.jsxs)(ButtonRow_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Button, { variant: "contained", color: "primary", onClick: handleSyncButtonClick, disabled: query.isFetching || updateMutation.isPending || forceDownloadMutation.isPending || forceUploadMutation.isPending
                                ...
                                (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(material_1.Divider, {}), (0, jsx_runtime_1.jsx)(ErrorAlert_1.default, { action: (0, jsx_runtime_1.jsx)(material_1.Button, { color: "error", variant: "contained", size: "small", disabled: query.isFetching || updateMutation.isPending || forceUploadMutation.isPending, loading: forceUploadMutation.isPending, children: "Upload" }), content: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { children: "If you know that the files on this device are newer, you can upload them instead." }), (0, jsx_runtime_1.jsx)(material_1.Typography, { children: "Only use this option if you're absolutely sure!" })] }) })] }), syncState?.requiresUpload === true && !syncState.neverSynced &&
                                (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(material_1.Divider, {}), (0, jsx_runtime_1.jsx)(ErrorAlert_1.default, { action: (0, jsx_runtime_1.jsx)(material_1.Button, { color: "error", variant: "contained", size: "small", onClick: () => forceDownloadMutation.mutate(gameId), disabled: query.isFetching || updateMutation.isPending || forceDownloadMutation.isPending, loading: forceDownloadMutation.isPending, children: "Download" }), content: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { children: "If you know that the files on this device are older, you can download them instead." }), (0, jsx_runtime_1.jsx)(material_1.Typography, { children: "Only use this option if you're absolutely sure!" })] }) })] })] })
                    :
