...
function ApiStatus() {
    ...
    return (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(SectionTitle_1.default, { title: "EmuSync agent status", icon: (0, jsx_runtime_1.jsx)(MonitorHeart_1.default, {}) }), (0, jsx_runtime_1.jsx)(AgentStatusHarness_1.AgentStatusAlert, { running: agentStatus.isRunning })] });
}
