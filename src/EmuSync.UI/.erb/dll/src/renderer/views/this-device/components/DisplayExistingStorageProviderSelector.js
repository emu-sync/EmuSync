...
function DisplayExistingStorageProvider({ provider }) {
    ...
    return (0, jsx_runtime_1.jsxs)(material_1.Paper, { elevation: 3, sx: {
            p: 2
        }, component: HorizontalStack_1.default, justifyContent: "space-between", children: [(0, jsx_runtime_1.jsx)(StorageProviderDetails_1.default, { image: providerDetails.image, name: providerDetails.name, justifyContent: "start" }), (0, jsx_runtime_1.jsx)(material_1.Button, { color: "error", variant: "contained", disabled: isMutating, loading: isMutating, title: "Unlink this device from the provider", onClick: handleMutation, children: "Unlink" })] });
}
