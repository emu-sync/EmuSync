...
function DisplayGameSyncStatus({ gameSyncStatus }) {
    ...
    const AlertMemo = (0, react_1.useMemo)(() => {
        ...
        if (syncState.localPathIsUnset) {
            return (0, jsx_runtime_1.jsx)(WarningAlert_1.default, { content: "A sync location must be set for this device." });
        }
        ...
        const lastSync = lastSyncExists ?
            (0, jsx_runtime_1.jsxs)(material_1.Typography, { children: ["Last synced from ", (0, jsx_runtime_1.jsx)(Pre_1.Pre, { children: lastSyncSourceName }), " ", displayDate, " at ", (0, jsx_runtime_1.jsx)(Pre_1.Pre, { children: displayFullDate }), "."] })
            : undefined;
        if (syncState.requiresUpload) {
            return (0, jsx_runtime_1.jsx)(WarningAlert_1.default, { action: storageChip, content: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { children: "Game files are newer and require uploading" }), lastSync] }) });
        }
