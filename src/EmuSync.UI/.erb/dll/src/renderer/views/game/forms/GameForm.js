...
function GameForm({ isEdit, query, saveMutation }) {
    ...
    return (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(SectionTitle_1.default, { title: "Game details", icon: (0, jsx_runtime_1.jsx)(Icon, {}) }), (0, jsx_runtime_1.jsx)(LoadingHarness_1.default, { query: query, loadingState: (0, jsx_runtime_1.jsx)(LoadingState, {}), children: (0, jsx_runtime_1.jsx)("form", { onSubmit: handleSubmit(handleFormSubmit), children: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: "name", control: control, rules: {
                                ...
                                (0, jsx_runtime_1.jsx)(WarningAlert_1.default, { content: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsxs)(material_1.Typography, { children: ["You should only enable AutoSync if you're ", (0, jsx_runtime_1.jsx)("strong", { children: "absolutely" }), " sure."] }), (0, jsx_runtime_1.jsx)(material_1.Typography, { children: "AutoSync can destructively overwrite game files if you open a game that isn't synced to this device yet." })] }) }), (0, jsx_runtime_1.jsxs)(material_1.Paper, { elevation: 3, sx: {
                                    p: 2
                                        ...
                                        return (0, jsx_runtime_1.jsx)(react_hook_form_1.Controller, { name: `syncSourceIdLocations.${src.id}`, control: control, render: ({ field }) => {
                                                return (0, jsx_runtime_1.jsxs)(HorizontalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(DefaultTextField_1.default, { field: field, placeholder: isThisDevice ? "Pick or enter a location" : "Enter a location", label: label, disabled: disabled || isSubmitting }), isThisDevice &&
                                                            (0, jsx_runtime_1.jsx)(PickDirectoryButton_1.default, { disabled: isSubmitting, onPickDirectory: (directory) => field.onChange(directory) })] });
                                            } }, src.id);
...
function LoadingState() {
    const [allSyncSources] = (0, jotai_1.useAtom)(all_sync_sources_1.allSyncSourcesAtom);
    return (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(TextFieldSkeleton_1.default, {}), (0, jsx_runtime_1.jsx)(CheckboxSkeleton_1.default, { width: 204 }), (0, jsx_runtime_1.jsxs)(material_1.Paper, { elevation: 3, sx: {
                    p: 2
                }, component: VerticalStack_1.default, children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { children: "Sync locations" }), allSyncSources.map((src) => {
