...
function AboutScreen() {
    ...
    return (0, jsx_runtime_1.jsx)(Container_1.default, { children: (0, jsx_runtime_1.jsxs)(VerticalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(SectionTitle_1.default, { title: "About EmuSync", icon: (0, jsx_runtime_1.jsx)(Icon, {}) }), (0, jsx_runtime_1.jsxs)(material_1.Paper, { gap: 1, elevation: 3, component: VerticalStack_1.default, sx: {
                        p: 2
                    }, children: [(0, jsx_runtime_1.jsxs)(HorizontalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { sx: { width: 100 }, children: "GUI version:" }), (0, jsx_runtime_1.jsx)(material_1.Chip, { label: window.electron.uiVersion, size: "small" })] }), (0, jsx_runtime_1.jsx)(AgentStatusHarness_1.default, { agentStatus: agentStatus, children: (0, jsx_runtime_1.jsx)(LoadingHarness_1.default, { query: agentInfoQuery, loadingState: (0, jsx_runtime_1.jsx)(AgentInfoLoadingState, {}), children: (0, jsx_runtime_1.jsxs)(HorizontalStack_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { sx: { width: 100 }, children: "Agent version:" }), (0, jsx_runtime_1.jsx)(material_1.Chip, { label: agentInfoQuery.data?.version, size: "small" })] }) }) })] }), (0, jsx_runtime_1.jsx)(ButtonRow_1.default, { children: (0, jsx_runtime_1.jsx)(material_1.Button, { color: "primary", variant: "contained", disabled: agentInfoQuery.isFetching || !agentStatus.isRunning, children: "Check for updates (TODO)" }) })] }) });
}
