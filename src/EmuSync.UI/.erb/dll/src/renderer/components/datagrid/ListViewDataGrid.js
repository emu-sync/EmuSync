...
function ListViewDataGrid({ columns, rows, loading, editHref, addButtonRedirect, addButtonItemName, reloadFunc, deleteFunc, getDeleteItemDetails }) {
    ...
    const Toolbar = (0, react_1.useCallback)(() => {
        return (0, jsx_runtime_1.jsx)(CustomToolbar_1.default, { addButtonRedirect: addButtonRedirect, itemName: addButtonItemName, loading: loading, reloadFunc: reloadFunc });
    }, [addButtonRedirect, addButtonItemName, loading, reloadFunc]);
